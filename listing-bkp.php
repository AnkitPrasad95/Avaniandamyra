...
if (isset($_POST['view_more_product'])) {
    ...
    //print_r($checkExistingUser); die;


    //this mail triggered to admin
    if ($contact_email != '' && $checkExistingUser['message'] != 'already_exist') {
    ...
    if ($_POST['Email']) {
        ...
        $message2 .= "<tr style=''>
            <th style='text-align:left;width: 27%;padding-left: 10px;padding-top: 12px;padding-bottom: 12px;'>Thank you for request with us. </th>
            </tr>";
                    ...
                    <form id="request_form" method="post">
                        <div class="row">
                            ...
                            <div class="form-group col-md-6 mb-5">
                                ...
                                <div class="position-relative">
                                    <input name="Phone" class="form-control" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" type = "number" maxlength = "15" maxlength="15" placeholder="Enter Phone Number">
                                </div>
                            </div>
                            <div class="form-group col-md-6 mb-5">
