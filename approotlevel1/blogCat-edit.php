...
if(isset($_POST['form1'])) {
	...
	if($valid == 1) {
        	...
        	$statement = $pdo->prepare("UPDATE tbl_blog_category SET name=?, slug=?, meta_title=?, meta_keyword=?, meta_description=? WHERE id=?");
    		$statement->execute(array($_POST['name'], $_POST['slug'], $_POST['meta_title'],$_POST['meta_keyword'],$_POST['meta_description'],$_REQUEST['id']));
		
		
		$success_message = 'Blog Category is updated successfully!';
	}
}
?>
