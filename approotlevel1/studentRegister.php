...
<section class="content-header">
	<div class="content-header-left">
		<h1>View Registered Student</h1> 
	</div>
	<div class="content-header-right">
        <!-- <a href="channelpartner-csv.php" class="btn btn-primary btn-sm">Export as CSV</a> -->
							...
							foreach ($result as $row) {
								...
								<tr <?php if($row['read_status'] == 0){ ?> style="background-color:pink;" <?php } ?>>
									...
									<td>	
										...
										<!-- <a href="channelpartner-edit.php?id=<?php echo $row['id']; ?>" class="btn btn-primary btn-xs" target="_blank">Edit</a> -->
										<!-- <a href="#" class="btn btn-danger btn-xs" data-href="channelpartner-delete.php?id=<?php echo $row['id']; ?>" data-toggle="modal" data-target="#confirm-delete">Delete</a>   -->
									</td>
								</tr>
								<?php
							}
