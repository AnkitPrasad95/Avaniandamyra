...
<section class="content-header">
	<div class="content-header-left">
		<h1>Profile Submission Leads</h1>
	</div>
        ...
        <div class="box-body table-responsive">
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
            	<?php
            	$i=0;
            	$statement = $pdo->prepare("SELECT * FROM tbl_profile_submission order by id desc");
            	$statement->execute();
            	...
            	foreach ($result as $row) {
					...
					<tr <?php if($row['read_status'] == 0){ ?> style="background-color:pink;" <?php } ?>>
                        ...
                        <td>
                            ...
                            <a href="#" class="btn btn-danger btn-xs" data-href="profileleads-delete.php?id=<?php echo $row['id']; ?>" data-toggle="modal" data-target="#confirm-delete">Delete</a>  
                        </td>
	                </tr>
            		<?php
            	}
