...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="slider-add.php" class="btn btn-primary btn-sm" target="_blank">Add slider</a>
	</div>
</section>
						...
						<tbody>
							...
							foreach ($result as $row) {
								...
								<tr>
									...
									<td><?php echo $row['index_value']; ?></td>
									<td>										
										<a href="slider-edit.php?id=<?php echo $row['id']; ?>" class="btn btn-primary btn-xs" target="_blank">Edit</a>
