                    ...
                    <div class="row">
                            ...
                            <div class="col-md-5 align-self-center">
                                <div class="comment">
                                    <div class="product-discription">
                                        ...
                                        <p class="font-lg mid-dark-text mb-0" id="message-<?= $product_id; ?>"><?= $message; ?></p>
                        ...
                        <div class="col-md-3 d-flex justify-content-between align-items-center">
                            <div class="quantity">
                                ...
                                <input class="form-control" onKeyDown="if(this.value.length==6) return false;"  onchange="update_quantity(this, <?= $product_id; ?>)" type="number"  id="quantity-<?= $product_id; ?>"  name="quantity-<?= $product_id; ?>" value="<?php if($quantity > 1) { echo $quantity; } else { echo 1; } ?>" <?php //if ($quantity > 1) { echo 'readonly'; } ?> />
